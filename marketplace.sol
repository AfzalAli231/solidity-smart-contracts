/**
 *Submitted for verification at amoy.polygonscan.com on 2024-04-23
*/
...
contract NFTMarketplace is Ownable {
    ...
    function buyNFT(uint256 listingId) external payable {
        ...
        require(!listing.warranty, "NFT on Warranty");
    ...
    function placeBid(uint256 auctionId) external payable {
        ...
        require(
            msg.value >= auction.reservePrice || msg.sender == auction.seller,
            "Bid must meet reserve price or seller can bid"
        );
